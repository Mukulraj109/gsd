      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          <div className="flex justify-center mb-4">
            <div className="h-12 w-12 rounded-lg bg-[var(--primary)] flex items-center justify-center text-white font-bold text-xl">
              G
            </div>
          </div>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <p className="text-xs font-semibold text-[var(--heading)] mb-2">Test Accounts:</p>
