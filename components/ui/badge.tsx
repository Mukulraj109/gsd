  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        todo: "border-transparent bg-gray-200 text-gray-700",
        "in-progress": "border-transparent bg-[var(--secondary)] text-white",
        review: "border-transparent bg-[var(--warning)] text-white",
        done: "border-transparent bg-[var(--success)] text-white",
      },
    },
    defaultVariants: {
      variant: "default",
